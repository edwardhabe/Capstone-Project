...
I will begin by searching for potential errors within my data. To do so, I'll look at the levels of columns I plan to work with. 
...
Fitted values appear quite flat, but theoretical quantiles don't appear to fit the model well. From using autoplot, I can determine that my data should be good to carry on with statistical testing. 
